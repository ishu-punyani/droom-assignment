...
import "../styles/Celebrating10Years.css";
import "../styles/Pre-Defined-Fonts.css";

function Celebrating10Years() {
  return (
    <div className="celebrating10years">
      <div className="building"></div>
      <div className="rectangle"></div>
      <div className="sandeep-image"></div>
      <div className="sandeep-aggarwal">
      ...
      <div className="droom-badshah-ticket"></div>
      <div className="Group-164796"></div>
      <h2 className="spl-guest-text Inter-Semibold-36px">Special Guest for the Night</h2>
      <div className="Badshah"></div>
      <div className="Badshah-car"></div>
    </div>
  );
}

export default Celebrating10Years;
